...
function formatPropertyCardMarkdown(card) {
...
function formatPropertyReportMarkdown(report) {
...
const tools = [
    {
        ...
        description: 'Research a property address to get owner information, roof details, market value, and permits. Computes lead score based on property data.',
        inputSchema: { type: 'object', properties: { address: { type: 'string' }, response_format: { type: 'string', enum: ['markdown', 'json'] } }, required: ['address'] },
    },
    {
    ...
    },
    {
        ...
        inputSchema: { type: 'object', properties: { lat: { type: 'number' }, lng: { type: 'number' }, address: { type: 'string' } } },
    },
    {
    ...
    },
    {
        ...
        inputSchema: { type: 'object', properties: { lat: { type: 'number' }, lng: { type: 'number' }, address: { type: 'string' }, days: { type: 'number' } } },
    },
    {
        name: 'directive_get_hail_events',
        description: 'Get historical NOAA hail events near a location.',
        inputSchema: { type: 'object', properties: { lat: { type: 'number' }, lng: { type: 'number' }, address: { type: 'string' }, days: { type: 'number' }, radius_miles: { type: 'number' }, response_format: { type: 'string', enum: ['markdown', 'json'] } } },
    },
    {
        name: 'directive_score_lead',
        description: 'Compute lead score based on property characteristics.',
        inputSchema: { type: 'object', properties: { roof_age_years: { type: 'number' }, owner_phone: { type: 'string' }, market_value: { type: 'number' }, permit_count: { type: 'number' } } },
    },
    {
        ...
        try {
            switch (toolName) {
                case 'directive_research_property': {
                    ...
                    return { content: [{ type: 'text', text: truncateOutput(output, CHARACTER_LIMIT) }] };
                }
                ...
                case 'directive_get_forecast': {
                    ...
                    if (daytime.length === 0) {
                        return { content: [{ type: 'text', text: 'No forecast data available.' }] };
                    }
                ...
                case 'directive_ask_michael': {
                    ...
                    return { content: [{ type: 'text', text: response.reply }] };
                }
